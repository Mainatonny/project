...
class EADataset(torch.utils.data.Dataset):
    def __init__(self, data, graph_features, text_features, image_features):
        self.data = data
    ...
    def __getitem__(self, index):
        entity_pair = self.data[index]
        graph_feat = self.graph_features[entity_pair[0]]
        text_feat = self.text_features[entity_pair[0]]
        image_feat = self.image_features[entity_pair[0]]
