...
def initialize_exp(cfg):
    """Initialize logging for the experiment."""
    logger = logging.getLogger(cfg.exp_id)
...
def get_dump_path(cfg):
    """Get or create the dump path for logs and outputs."""
    path = os.path.join(os.getcwd(), 'experiments', cfg.exp_id)
